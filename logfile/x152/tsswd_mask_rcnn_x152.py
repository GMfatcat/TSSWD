# -*- coding: utf-8 -*-
"""
Created on Wed Apr  6 19:23:23 2022
...
cfg.MODEL.WEIGHTS =  '/home/eorslab/fatcat/detectron_training/model_zoo_weight/model_x152.pkl' # Let training initialize from model zoo pretrained model -x152
...
# Output path
cfg.OUTPUT_DIR = "./checkpoints_x152"
...
evaluator = COCOEvaluator("ship_test", output_dir="./evaluation_output_x152")
val_loader = build_detection_test_loader(cfg, "ship_test")
print(inference_on_dataset(predictor.model, val_loader, evaluator))


print("====Start Evaluation on Val Set====")
evaluator2 = COCOEvaluator("ship_val", output_dir="./evaluation_output_x152")
