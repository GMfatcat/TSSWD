# -*- coding: utf-8 -*-
"""
Created on Wed Apr  6 14:18:19 2022
...
# Output path
cfg.OUTPUT_DIR = "./checkpoints_x101"
...
evaluator = COCOEvaluator("ship_test", output_dir="./evaluation_output_x101")
val_loader = build_detection_test_loader(cfg, "ship_test")
print(inference_on_dataset(predictor.model, val_loader, evaluator))


print("====Start Evaluation on Val Set====")
evaluator2 = COCOEvaluator("ship_val", output_dir="./evaluation_output_x101")
